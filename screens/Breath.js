                ...
                <View style={styles.contentBlock}>
                    <View style={styles.contentItem}>
                        ...
                        <View style={styles.descBlock}>
                            <Text style={styles.descText}>Дыхание квадрат</Text>
                            <Image source={require('../img/icon_rectangle.png')} style={styles.descIcon}></Image>
                        </View>
                    </View>
                    <View style={styles.contentItem}>
                        <View style={styles.timeBlock}>
